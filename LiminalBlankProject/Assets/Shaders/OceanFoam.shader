...
////// Emissive:
                ...
                float node_2131 = (sin((16.0*(i.uv0.g+node_3473.r)))+1.0);
                return fixed4(finalColor,saturate(((0.5-node_2131)/fwidth(node_2131))));
            }
            ENDCG
        }
    }
