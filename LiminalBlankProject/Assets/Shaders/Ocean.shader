...
/// Final Color:
                ...
                return fixed4(finalColor,saturate((sqrt((node_308.r+node_308.g+node_308.b))*-0.001+1.0)));
            }
            ENDCG
        }
        Pass {
...
/// Final Color:
                ...
                float3 node_7697 = (i.posWorld.rgb-_WorldSpaceCameraPos);
                float3 node_308 = (node_7697*node_7697).rgb;
                return fixed4(finalColor * saturate((sqrt((node_308.r+node_308.g+node_308.b))*-0.001+1.0)),0);
            }
            ENDCG
        }
    }
