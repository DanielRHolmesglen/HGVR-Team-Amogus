    ...
    SubShader {
        ...
        Pass {
            ...
            VertexOutput vert (VertexInput v) {
                ...
                v.vertex.xyz += ((-2.0)*normalize((_WorldSpaceCameraPos-mul(unity_ObjectToWorld, v.vertex).rgb)));
...
/////// Diffuse:
                ...
                float3 diffuseColor = lerp(_Foam_var.rgb,_Water_var.rgb,(smoothstep( 0.008, 0.038, node_740 )+(node_740*0.15)));
                float3 diffuse = (directDiffuse + indirectDiffuse) * diffuseColor;
/// Final Color:
                float3 finalColor = diffuse + specular;
                float3 node_7697 = (i.posWorld.rgb-_WorldSpaceCameraPos);
                float3 node_308 = (node_7697*node_7697).rgb;
                float node_8066 = saturate((sqrt((node_308.r+node_308.g+node_308.b))*-0.0002857143+1.0));
