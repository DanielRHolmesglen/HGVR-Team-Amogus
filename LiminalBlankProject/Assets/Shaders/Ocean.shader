...
/// Final Color:
                ...
                float node_4337 = (sqrt((node_308.r+node_308.g+node_308.b))*-0.0002857143+1.0);
                float node_8066 = saturate(node_4337);
