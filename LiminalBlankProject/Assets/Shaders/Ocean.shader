...
/// Final Color:
                ...
                float node_4337 = (sqrt((node_308.r+node_308.g+node_308.b))*-0.001+1.0);
                return fixed4(finalColor,saturate(node_4337));
            }
            ENDCG
        }
        Pass {
...
/// Final Color:
                ...
                float3 node_308 = (node_7697*node_7697).rgb;
                float node_4337 = (sqrt((node_308.r+node_308.g+node_308.b))*-0.001+1.0);
                return fixed4(finalColor * saturate(node_4337),0);
            }
            ENDCG
        }
        Pass {
