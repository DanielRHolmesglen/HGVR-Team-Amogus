...
/////// Diffuse:
                ...
                float2 node_7769 = ((float2(0.0231,0.0231)*node_569.g)+node_973);
                float4 _NoiseTex = tex2D(_Noise,TRANSFORM_TEX(node_7769, _Noise));
                float2 node_5328 = ((float2(0.011,0.011)*node_569.g)+node_973);
