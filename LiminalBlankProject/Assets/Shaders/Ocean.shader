    ...
    SubShader {
        ...
        Pass {
            ...
            VertexOutput vert (VertexInput v) {
                ...
                float2 node_5328 = ((float2(0.01,0)*node_569.g)+(0.002*mul(unity_ObjectToWorld, v.vertex).rgb.rb));
                float4 _NoiseTex = tex2Dlod(_Noise,float4(TRANSFORM_TEX(node_5328, _Noise),0.0,0));
                float2 node_5521 = (sin((0.002*node_569.g))*node_5328);
                float4 _node_5435 = tex2Dlod(_Noise,float4(TRANSFORM_TEX(node_5521, _Noise),0.0,0));
                float node_740 = (_NoiseTex.r*_node_5435.r);
                float node_5839 = 0.01;
                float node_1681 = 0.04;
                float node_9292 = ((smoothstep( 0.008, 0.038, node_740 )-smoothstep( node_5839, node_1681, node_740 ))+((1.0 - node_740)*0.15));
                float node_7915 = node_9292;
