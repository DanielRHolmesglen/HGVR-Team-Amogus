    ...
    SubShader {
        ...
        Pass {
            ...
            VertexOutput vert (VertexInput v) {
                ...
                float node_5998 = 1.0;
                float3 node_8471 = (mul(unity_ObjectToWorld, v.vertex).rgb-_WorldSpaceCameraPos);
                float3 node_9678 = (node_5998*normalize(node_8471));
                v.vertex.xyz += (recipObjScale*node_9678);
