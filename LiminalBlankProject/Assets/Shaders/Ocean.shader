    ...
    SubShader {
        ...
        Pass {
            ...
            VertexOutput vert (VertexInput v) {
                ...
                v.vertex.xyz += ((-8.0)*normalize((_WorldSpaceCameraPos-mul(unity_ObjectToWorld, v.vertex).rgb)));
...
/// Final Color:
                ...
                float node_8066 = saturate((sqrt((node_308.r+node_308.g+node_308.b))*-0.0005+1.0));
