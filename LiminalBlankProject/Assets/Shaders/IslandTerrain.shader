...
/////// Diffuse:
                ...
                float2 node_1224 = float2(0,0.001);
                float2 node_8735 = (node_7413+node_1224);
                float4 _Texture_copy = tex2D(_node_1853,TRANSFORM_TEX(node_8735, _node_1853));
                float node_2091 = 0.5;
                float3 diffuseColor = lerp(_Texture.rgb,_Texture_copy.rgb,node_2091);
