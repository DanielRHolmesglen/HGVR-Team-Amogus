...
/////// Diffuse:
                ...
                float2 node_6765 = (i.posWorld.rgb-_WorldSpaceCameraPos).rb;
                float node_3183 = distance(i.posWorld.rgb,_WorldSpaceCameraPos);
                float node_9648 = clamp((node_3183*-0.004+4.0),0,4);
